    ...
    <main class="mx-auto">
      <section v-if="mode === 'collection'" class="flex flex-col divide-y">
        ...
        >
          ...
          <FGButton :disabled="id === ''" variant="outline" :color="id === '' ? 'gray' : 'teal'" size="lg" @click="loadCollection">
            Load Collection
          </FGButton>
        </form>
      </section>
