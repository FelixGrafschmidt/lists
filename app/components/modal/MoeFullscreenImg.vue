<template>
  <div class="relative h-screen max-h-screen w-screen" @click.stop>
    ...
    >
      <div
        v-show="showThumbs"
        class="h-1/2 max-h-[6rem] min-h-[6rem] flex gap-1 overflow-x-scroll bg-gray-700 bg-opacity-50 px-8 scrollbar scrollbar-thumb-color-gray-9 scrollbar-track-color-gray-500 scrollbar-rounded scrollbar-radius-2 scrollbar-thumb-radius-4 scrollbar-track-radius-4 scrollbar-w-2"
      >
        <figure
