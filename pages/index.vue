<template>
	<div class="max-h-screen min-h-screen flex flex-col">
		...
		<div class="flex grow flex-row">
			...
			<div
				class="grow overflow-auto scrollbar-thumb-color-gray-9 scrollbar-track-color-gray-500 scrollbar-radius-2 scrollbar-thumb-radius-4 scrollbar-track-radius-4 scrollbar-w-2 scrollbar scrollbar-rounded"
			>
				<NuxtPage />
			</div>
		</div>
